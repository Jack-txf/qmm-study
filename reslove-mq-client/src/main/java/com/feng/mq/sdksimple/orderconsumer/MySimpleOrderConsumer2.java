package com.feng.mq.sdksimple.orderconsumer;
 ...
 * @Date: 2025/5/20
 */
public class MySimpleOrderConsumer2 {
    ...
    public static void simpleOrderConsumer() throws ClientException {
        ...
        PushConsumer pushConsumer = provider.newPushConsumerBuilder()
                ...
                .setMessageListener(messageView -> {
                    ...
                    System.out.println("消费者2 【顺序消息】 successfully, messageId=" + messageView.getMessageId() + "【】" +str);
