...
import com.feng.netty.day2.chatdemo.message.GroupQuitRequestMessage;
...
public class QuitGroupMessageHandler extends SimpleChannelInboundHandler<GroupQuitRequestMessage> {
    // gquit [group name]   (username在登录环节已经存起来了,发送消息的时候封装进了msg里面)
    @Override
